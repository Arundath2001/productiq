            ...
            >               
              <div className="flex flex-col">
                ...
                <div className="flex items-center mt-1">
                  ...
                  <span className="text-xs font-medium text-blue-600 bg-blue-50 px-2 py-0.5 rounded-md">{savedCode.companyCode}</span>
                </div>
              </div>                

              <div className="flex gap-2.5 items-center">                 
                <p className="text-xs text-gray-600">Created: {formatDate(savedCode.createdAt)}</p>                  
                ...
                <div onClick={() => handleShowConfirm(savedCode._id)} className="group">                   
                  <FaTrash className="cursor-pointer text-gray-500 group-hover:text-red-500 transition-colors duration-200" size={15} />                 
                </div>               
              </div>             
            </div>           
          ))         
